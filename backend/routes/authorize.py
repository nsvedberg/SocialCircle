...
def register_routes():
    ...
    @router.route("/b/login", methods=["POST"])
    def login():
            """
    ...
    current_app.config['OAUTH2_PROVIDERS'] = {
    ...
    @router.route('/b/authorize/<provider>')
    ...
    @router.route('/b/authorize/<provider>/callback')
