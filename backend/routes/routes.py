...
from db.models import Club, Event, User, Comment

from flask import Blueprint, abort, jsonify, request

from routes.authorize import login_required


router = Blueprint('user', __name__)

@router.route('/b/clubs/new', methods=['POST'])
def create_club():
    session = Session()
...
@router.route('/b/clubs', methods=['GET'])
def get_all_clubs():
...
@router.route('/b/clubs/name/<string:club_name>', methods=['GET'])
...
@router.route('/b/events/name/<string:event_name>', methods=['GET'])
...
@router.route('/b/clubs/<int:club_id>', methods=['GET'])
...
@router.route('/b/clubs/<int:club_id>', methods=['DELETE'])
...
@router.route('/b/clubs/<int:club_id>', methods=['PUT'])
...
@router.route('/b/clubs/<int:club_id>/comments', methods=['POST'])
...
@router.route('/b/clubs/<int:club_id>/comments', methods=['GET'])
...
@router.route('/b/clubs/<int:club_id>/comments/<int:comment_id>/edit', methods=['GET', 'POST'])
...
@router.route('/b/clubs/<int:club_id>/comments/<int:comment_id>/delete', methods=['DELETE'])
...
@router.route('/b/events/new', methods=['POST'])
def create_event():
    session = Session()
    data = request.get_json()
...
@router.route('/b/events', methods=['GET'])
def get_events():
    return Session().query(Event).all()

@router.route('/b/events/<int:event_id>', methods=['GET'])
def get_event(event_id):
    event = Session().query(Event).get(event_id)
    return jsonify(event)

@router.route('/b/events/<int:event_id>', methods=['DELETE'])
...
@router.route('/b/events/<int:event_id>', methods=['PUT'])
...
@router.route('/b/users/new', methods=['POST'])
def create_user():
    session = Session()
    data = request.get_json()
...
@router.route('/b/users', methods=['GET'])
def get_all_users():
...
@router.route('/b/users/<int:user_id>', methods=['GET'])
...
@router.route('/b/users/<int:user_id>', methods=['DELETE'])
...
@login_required
@router.route('/b/users/<int:user_id>', methods=['PUT'])
...
@router.route('/b/users/<int:user_id>/add-to-club/<int:club_id>', methods=['POST'])
...
@router.route('/b/users/<int:user_id>/remove-from-club/<int:club_id>', methods=['DELETE'])
...
@router.route('/b/users/<int:user_id>/clubs', methods=['GET'])
