...
@app.route('/b/add_user_to_groupchat', methods=['POST'])
...
@app.route('/b/user_groupchats/<int:user_id>', methods=['GET'])
def get_user_groupchats(user_id):
    ...
    try:
        ...
        groupchats = [{"groupchat_id": gc.id, "add_user_to_groupchat_id": gc.club_id} for gc in user.groupchats]
